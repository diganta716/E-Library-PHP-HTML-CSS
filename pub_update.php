...
<html>
	...
	<div class="page">
			...
			<div class="body">
                    <body>
					    <p class = "back"><a href="delete_request.php"><- Go Back</a></p>
					</body>
					<?php
                    ...
                    ?>
                    <form action = "pub_update.php" method = "GET">
                        Book ID: <?php echo "$bookid" ?><br><input type = "hidden" value = "<?php echo "$bookid" ?>" name = "bid"> <br/>
						Book Publisher ID: <?php echo "$pid" ?><br><input type = "hidden" value = "<?php echo "$pid" ?>" name = "pid"><br> <br/>
                        ...
                        Book Publish Date: <br><input type = "text" value = "<?php echo "$pubdate" ?>" name = "pub_date"><br> <br/>
                    ...
                    <?php
                        if(isset($_GET['submit'])) {
                            ...
                            $query = "UPDATE book SET ISBN='$isbn', TITLE='$title', EDITION='$edition', DESCRIPTION='$desc'
                            ...
                            if($data) {
                                ...
                                header("Location: delete_request.php");
                            }
                            else {
